...
<template>
    ...
    <div class="flex min-h-svh flex-col bg-surface-wash">
        <main
            class="flex flex-1 flex-col items-center justify-center px-4 py-12 md:py-20"
        >
            <article
                ...
                <form novalidate class="space-y-3" @submit.prevent="submit">
                    ...
                    <div class="space-y-2">
                        ...
                        <p id="email-help" class="text-meta text-ink-secondary">
                            It starts {{ forecastStartLabel }} and runs through
                            your trip — so you're ready to pack, and ready for
                            the day.
                        </p>
                    </div>
